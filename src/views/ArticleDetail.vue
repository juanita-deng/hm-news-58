<template>
  <div class="hm-articleList" :class="isShow ? 'pd150' : 'pd80'">
    ...
    <!-- 文章内容-图片类内容 -->
    <div class="article-content" v-html="detail.content" v-if="detail.type === 1">
      <!-- {{ detail.content }}有标签 -->
    </div>
    ...
    <div class="article-content" v-else>
      <video :src="detail.content" controls autoplay muted></video>
    </div>
    ...
    <div class="hm-comments">
      ...
      <!-- 评论组件 -->
      <hm-comments v-for="item in comments" :key="item.id" :comment="item"></hm-comments>
      <!--改用bus @reply="reply" -->
    </div>
